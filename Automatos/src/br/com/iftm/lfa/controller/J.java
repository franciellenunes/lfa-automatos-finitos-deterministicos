...
/**
 * Classe criada para resolução do exercício correspondente a letra J Linguagem
 * é um número inteiro, um número decimal ou um número representado em notação
 * científica
 *
